    ...
    sortInput.addEventListener("change", (e) => {
        ...
        if (nutrient === "sort by nutrient") {
            ...
            currentRecipes = [...recipes].sort((a, b) => {
                ...
                if (nutrient === "energy") return parseInt(b.nutrition.energy) - parseInt(a.nutrition.energy);
                if (nutrient === "fat") return parseInt(b.nutrition.fat) - parseInt(a.nutrition.fat);
                if (nutrient === "carbohydrate") return parseInt(b.nutrition.carbohydrate) - parseInt(a.nutrition.carbohydrate);
                if (nutrient === "protein") return parseInt(b.nutrition.protein) - parseInt(a.nutrition.protein);
...
if (categoryInput) {
    ...
    categoryInput.addEventListener("change", (e) => {
        ...
        currentRecipes = category === "category" ? recipes : recipes.filter(recipe => recipe.category === category);
        // Đặt lại về trang đầu tiên sau khi lọc
        currentPage = 1;
        // Hiển thị danh sách công thức đã lọc
        renderRecipes(currentRecipes);
